...
class infoHepa extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        ...
        appBar: AppBar(
          title: Text('Information of Hepa'),
          centerTitle: true,
                  ...
                  TableCell(
                   ...
                   TableCell(
                    child: Padding(
                      padding: EdgeInsets.all(16.0),
                      child: Center(child: 
                      Text('Info Yuran:- Pelajar hendaklah membayar yuran sebelum memasuki dewan peperiksaan'),
                      ),
                    ),
                   ),
                   TableCell(
                  ...
                  TableCell(
                   ...
                   TableCell(
                    child: Padding(
                      padding: EdgeInsets.all(16.0),
                      child: Center(child: 
                      Text('Info Subjek:- Semua pelajar tahun 1 telah didaftarkan subjek asas bagi setiap program'),
                      ),
                    ),
                   ),
                   TableCell(
